            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-600 dark:text-gray-400">
                  <strong className="text-gray-900 dark:text-white">Average Fitness</strong> - Mean fitness score across the entire population
                </span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-4 h-0.5 bg-purple-500" />
                <span className="text-gray-600 dark:text-gray-400">
                  <strong className="text-gray-900 dark:text-white">Peak Fitness</strong> - Highest fitness score in the population
                </span>
              </div>
              <div className="flex items-center gap-3">
          ...
          <div className="pt-2 border-t border-gray-200 dark:border-gray-700">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="text-gray-600 dark:text-gray-400 pl-5">
                <div className="mt-1"><strong className="text-gray-900 dark:text-white">Avg Fitness:</strong> Population average fitness score</div>
                <div className="mt-1"><strong className="text-gray-900 dark:text-white">Peak Fitness:</strong> Highest individual agent fitness</div>
                ...
                <div className="mt-1"><strong className="text-gray-900 dark:text-white">Min Fitness:</strong> Lowest fitness score in population</div>
                <div className="mt-1"><strong className="text-gray-900 dark:text-white">Std Fitness:</strong> Standard deviation of fitness scores</div>
              </div>
            </div>
          </div>
